  ...
  return (
    <>
      ...
      <div className="bg-white rounded-md w-[400px] duration-300 md:w-[500px] py-4 px-4 shadow-xl">
        ...
        <div className="">
          <Link
            className="flex items-center gap-4 px-4 justify-center py-2 font-semibold text-sm border rounded-md text-gray-700 hover:bg-gray-100 transition duration-300 mb-2"
            href={`${process.env.NEXT_PUBLIC_BASE_URL}/auth/google/url`}
          >
            <svg
              viewBox="0 0 512 512"
              width={23}
