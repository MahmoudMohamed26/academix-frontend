    ...
    <div className="bg-[var(--main-bg)]">
      <div className=" min-h-screen flex items-center justify-center gap-10 lg:justify-between">
        <div className="flex flex-col items-center grow md:ms-10">
          ...
          <div className="mt-10 pb-15 flex gap-2 items-center">
            <Select onValueChange={changeLanguage} defaultValue={i18n.language}>
              <SelectTrigger className="w-[120px] text-[var(--main-color)] border-[var(--main-color)] rounded-md">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="en">
